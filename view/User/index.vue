<template>
  <div class="manage">
    ...
    <div class="manage-header">
      ...
      <common-form :formlabel="formlabel" :form="serachForm" :inline="true" ref="form">
        <el-button type="primary" @click="getList(serachForm.keyword)">搜索</el-button>
      </common-form>
    </div>
